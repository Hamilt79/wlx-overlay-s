...
pub fn save_settings(config: &GeneralConfig) -> anyhow::Result<()> {
    let conf = AutoSettings {
        ...
        space_gravity_floor_enabled: config.space_gravity_floor_enabled,
        space_gravity_floor_height: config.space_gravity_floor_height,
        space_boost_speed: config.space_boost_speed,
        space_boost_deadzone: config.space_boost_deadzone,
